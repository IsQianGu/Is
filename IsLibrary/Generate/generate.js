(function (w) {
    var is = function (e) {
        this.ProgressBar.container = Object();
        this.ProgressBar.is_data = document.getElementById(e);
    };
    is.prototype = {
        ProgressBar: {
            Model: function (m, s) {
            ...
            circular: function (w, s, c, fn) {
                ...
                fn(_this.container.circular.radata.rafun)
            },
